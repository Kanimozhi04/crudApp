...
import {CardContent,CardActions,Card,CardMedia,Typography,Box,Paper,TextField,Button,Avatar} from '@mui/material';
          ...
          <div>
           {
                productdetails && productdetails.map(Values =>{
                  ...
                  <Card sx={{ maxWidth: 345,bgcolor:"#95f089",mb:"1%"}} className='product'>
                        <CardMedia component="img" height="200" image="dog.jpg"alt="dog" />
